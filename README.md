...
```bash
git clone https://github.com/<ananyaacodes>/<Nudge-VIBE2SHIP-CodingNinjasXGoogleForDeveloper-2026>.git
```

### Navigate into the project

```bash
cd <Nudge-VIBE2SHIP-CodingNinjasXGoogleForDeveloper-2026>
```
